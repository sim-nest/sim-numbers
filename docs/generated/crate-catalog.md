...
| `sim-lib-numbers-arith` | `true` | `lib` | SIM workspace package for sim lib numbers arith. |
| `sim-lib-numbers-bigint` | `true` | `lib` | SIM workspace package for sim lib numbers bigint. |
| `sim-lib-numbers-bool` | `true` | `lib` | SIM workspace package for sim lib numbers bool. |
...
| `sim-lib-numbers-cas` | `true` | `lib` | SIM workspace package for sim lib numbers cas. |
| `sim-lib-numbers-codec` | `true` | `lib` | SIM workspace package for sim lib numbers codec. |
| `sim-lib-numbers-complex` | `true` | `lib` | SIM workspace package for sim lib numbers complex. |
...
| `sim-lib-numbers-func` | `true` | `lib` | SIM workspace package for sim lib numbers func. |
| `sim-lib-numbers-i64` | `true` | `lib` | SIM workspace package for sim lib numbers i64. |
...
| `sim-lib-numbers-rational` | `true` | `lib` | SIM workspace package for sim lib numbers rational. |
...
| `sim-lib-numbers-tensor-cmplxf` | `true` | `lib` | SIM workspace package for sim lib numbers tensor cmplxf. |
...
| `sim-lib-numbers-tensor-rat64` | `true` | `lib` | SIM workspace package for sim lib numbers tensor rat64. |
| `sim-lib-numbers-tensor` | `true` | `lib` | SIM workspace package for sim lib numbers tensor. |
