//! Deterministic double-double arithmetic and number-domain integration.
...
fn promote_to_extended(_cx: &mut sim_kernel::Cx, n: NumberLiteral) -> Result<NumberLiteral> {
...
pub(crate) fn promotion_rules() -> Vec<PromotionRule> {
    vec![
        PromotionRule {
