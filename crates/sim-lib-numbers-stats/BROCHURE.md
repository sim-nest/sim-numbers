...
This is the statistics and probability layer of the SIM number stack. It supplies generic summaries and finite-state inference; domain adapters keep their own state and symbol meanings outside the numbers repository.
