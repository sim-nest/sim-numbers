...
fn concat(cx: &mut Cx, r: &TensorRequest) -> std::result::Result<Tensor, TensorExecError> {
...
fn pad(cx: &mut Cx, r: &TensorRequest) -> std::result::Result<Tensor, TensorExecError> {
    let t = unary(r)?;
...
fn diff(cx: &mut Cx, r: &TensorRequest) -> std::result::Result<Tensor, TensorExecError> {
    let t = unary(r)?;
